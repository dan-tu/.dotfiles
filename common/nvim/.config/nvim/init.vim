...
" Enable below to skip view saving for certain files
...
" Saves view when closing vim and restores when opening 
" View files can grow over time so you may need to run a cron job to
" cleanup...
